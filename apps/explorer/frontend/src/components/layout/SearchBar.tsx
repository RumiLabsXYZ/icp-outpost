...
export function SearchBar() {
  ...
  function onSubmit(e: FormEvent) {
    ...
    // Generic entity: anything else, route to entity detail with kind=id
    navigate(`/e/entity/${encodeURIComponent(v)}`);
  }
  ...
  return (
    <form onSubmit={onSubmit} className="flex-1 max-w-xl">
      <input
        ...
        placeholder="search principal, event id..."
